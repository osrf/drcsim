...
void VRCPlugin::UpdateStates()
{
  ...
  else if (this->atlas.startupSequence == Robot::INITIALIZED)
  {
    ...
    if (true && cylinderModel)
    {
      ...
      if (!title)
      {
        ...
        std::cout
          ...
          << ", " << "Right Cyl-Hand Position Y (m)"
          << ", " << "Right Cyl-Hand Position Z (m)"
          << ", " << "Right Cyl-Hand Orientation X (m)"
          << ", " << "Right Cyl-Hand Orientation Y (m)"
          << ", " << "Right Cyl-Hand Orientation Z (m)"
          << ", " << "Right Cyl-Hand Velocity X (m/s)"
          << ", " << "Right Cyl-Hand Velocity Y (m/s)"
          << ", " << "Right Cyl-Hand Velocity Z (m/s)"
          << ", " << "Right Cyl-Hand Roll Rate (rad/s)"
          << ", " << "Right Cyl-Hand Pitch Rate (rad/s)"
          << ", " << "Right Cyl-Hand Yaw Rate (rad/s)"
          << ", " << "Right Hand Position X (m)"
          << ", " << "Right Hand Position Y (m)"
          << ", " << "Right Hand Position Z (m)"
          << ", " << "Right Hand Orientation X (m)"
          << ", " << "Right Hand Orientation Y (m)"
          << ", " << "Right Hand Orientation Z (m)"
          << ", " << "Right Hand Velocity X (m/s)"
          << ", " << "Right Hand Velocity Y (m/s)"
          << ", " << "Right Hand Velocity Z (m/s)"
          << ", " << "Right Hand Roll Rate (rad/s)"
          << ", " << "Right Hand Pitch Rate (rad/s)"
          << ", " << "Right Hand Yaw Rate (rad/s)"
          << "\n";
        title = true;
      }
      else
      {
        ...
        std::cout
          ...
          << ", " << relPose.pos.y
          << ", " << relPose.pos.z
          << ", " << relPose.rot.GetAsEuler().x
          << ", " << relPose.rot.GetAsEuler().y
          << ", " << relPose.rot.GetAsEuler().z
          << ", " << relLinearVel.x
          << ", " << relLinearVel.y
          << ", " << relLinearVel.z
          << ", " << relAngularVel.x
          << ", " << relAngularVel.y
          << ", " << relAngularVel.z
          << ", " << rHandLink->GetWorldPose().pos.x
          << ", " << rHandLink->GetWorldPose().pos.y
          << ", " << rHandLink->GetWorldPose().pos.z
          << ", " << rHandLink->GetWorldPose().rot.GetAsEuler().x
          << ", " << rHandLink->GetWorldPose().rot.GetAsEuler().y
          << ", " << rHandLink->GetWorldPose().rot.GetAsEuler().z
          << ", " << rHandLink->GetWorldLinearVel().x
          << ", " << rHandLink->GetWorldLinearVel().y
          << ", " << rHandLink->GetWorldLinearVel().z
          << ", " << rHandLink->GetWorldAngularVel().x
          << ", " << rHandLink->GetWorldAngularVel().y
    ...
    {
      // collect data for stand, walk case
      physics::PhysicsEnginePtr physics = this->world->GetPhysicsEngine();
