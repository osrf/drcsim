...
int main(int argc, char** argv)
{
  ...
  jointNames.push_back("atlas::back_bkz");
  jointNames.push_back("atlas::back_bky");
  jointNames.push_back("atlas::back_bkx");
  jointNames.push_back("atlas::neck_ry");
  jointNames.push_back("atlas::l_leg_hpz");
  jointNames.push_back("atlas::l_leg_hpx");
  jointNames.push_back("atlas::l_leg_hpy");
  jointNames.push_back("atlas::l_leg_kny");
  jointNames.push_back("atlas::l_leg_aky");
  jointNames.push_back("atlas::l_leg_akx");
  jointNames.push_back("atlas::r_leg_hpz");
  jointNames.push_back("atlas::r_leg_hpx");
  jointNames.push_back("atlas::r_leg_hpy");
  jointNames.push_back("atlas::r_leg_kny");
  jointNames.push_back("atlas::r_leg_aky");
  jointNames.push_back("atlas::r_leg_akx");
  jointNames.push_back("atlas::l_arm_shy");
  jointNames.push_back("atlas::l_arm_shx");
  jointNames.push_back("atlas::l_arm_ely");
  jointNames.push_back("atlas::l_arm_elx");
  jointNames.push_back("atlas::l_arm_wry");
  jointNames.push_back("atlas::l_arm_wrx");
  jointNames.push_back("atlas::r_arm_shy");
  jointNames.push_back("atlas::r_arm_shx");
  jointNames.push_back("atlas::r_arm_ely");
  jointNames.push_back("atlas::r_arm_elx");
  jointNames.push_back("atlas::r_arm_wry");
  jointNames.push_back("atlas::r_arm_wrx");
