 ...
 * SVN: $Id$
 */
#ifndef ROS_JOINT_TRAJECTORY_PLUGIN_HH
#define ROS_JOINT_TRAJECTORY_PLUGIN_HH
...
#include <ros_plugins/SetJointTrajectory.h>
...
namespace gazebo
{
   ...
   class RosJointTrajectory : public ModelPlugin
   {
      /// \brief Constructor
      public: RosJointTrajectory();

      /// \brief Destructor
      public: virtual ~RosJointTrajectory();
      ...
      private: bool SetTrajectory(const ros_plugins::SetJointTrajectory::Request& req,
                                  const ros_plugins::SetJointTrajectory::Response& res);
