...
struct AtlasBehaviorStepData
{
	...
	//!
	//!  \brief  Foot orientation yaw component.
	//!
	float yaw;
	...
	float swing_height;     //!<  Step apex swing height as measured from the midpoint between the feet.
...
{
	//!
	//!  \brief  Position of next desire step.
	//!
...
struct AtlasBehaviorWalkFeedback
{
	...
	//!
	//!    The step index will increases as Walk progresses.  It will reset to
	...
	//!
	//!  \brief  Saturated copy of step_data from user.
	//!
	...
	//!
	AtlasBehaviorStepData step_data_saturated[NUM_REQUIRED_WALK_STEPS];
...
struct AtlasBehaviorFeedback
{
	...
	//!
	//!  \brief  Feedback specific to the Stand behavior.
	//!
	AtlasBehaviorStandFeedback stand_feedback;

	//!
	//!  \brief  Feedback specific to the Step behavior.
	//!
	AtlasBehaviorStepFeedback step_feedback;

	//!
	//!  \brief  Feedback specific to the Walk behavior.
	//!
	AtlasBehaviorWalkFeedback walk_feedback;

	//!
	//!  \brief  Feedback specific to the Manipulate behavior.
	//!
