...
////////////////////////////////////////////////////////////////////////////////
// Increment count
void GazeboRosDepthCamera::InfoConnect()
{
  this->info_connect_count_++;
}
////////////////////////////////////////////////////////////////////////////////
// Decrement count
void GazeboRosDepthCamera::InfoDisconnect()
{
  this->info_connect_count_--;
}
...
void GazeboRosDepthCamera::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  ros::AdvertiseOptions depth_image_camera_info_ao =
    ros::AdvertiseOptions::create<sensor_msgs::CameraInfo>(
        ...
        boost::bind( &GazeboRosDepthCamera::InfoConnect,this),
        boost::bind( &GazeboRosDepthCamera::InfoDisconnect,this),
        ros::VoidPtr(), &this->camera_queue_);
