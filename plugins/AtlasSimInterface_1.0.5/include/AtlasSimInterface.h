...
public:
	...
	//! \_Returns
	//!
	//!    NO_ERRORS on success, error code on failure
	//!
...
//	///////////////////////////////////////////////////////
//	//!
//	//! \brief  Helper function for setting next multi_step data.
//	//!
//	//! \_Description
//	//!
//	//!    This is a helper function that sets the next multi_step data.  It
//	//!    Removes the previous current step, shifts other steps down, and
//	//!    adds the new step.
//	//!
//	//!    The data members of step_params, include step number, must already
//	//!    be filled out.
//	//!
//	AtlasErrorCode add_multistep_step(AtlasControlDataToRobot& to_robot,
//		const AtlasBehaviorStepParams& step_params);
